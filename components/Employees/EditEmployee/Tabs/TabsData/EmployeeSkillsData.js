...
import EditEmployeeSkills from "../../RelatedTables/Edit/EditEmployeeSkills";

const EmployeeSkillsData = ({ employeeData, skillCategories, skillLevel }) => {
  ...
  if (
    ...
    const [employeeSkillsData, setEmployeeSkillsData] = useState(
      employeeData[0].employee_skills
    );

    const deleteEmployeeSkills = (deleteData) => {
      let _EmployeeSkillsData = employeeSkillsData.filter(
        (val) => val.id !== deleteData.id
      );
      setEmployeeSkillsData(_EmployeeSkillsData);
      ...
      const url = `${process.env.NEXT_PUBLIC_SUPABASE_URL}/employee_skills?id=eq.${deleteData.id}`;
      axios.delete(url, {
        headers: {
        ...
        <React.Fragment>
          ...
          >
            ...
            <div className="text-right mr-10 ">
              ...
              <button className="btn ml-3" type="submit" form="editSkills">
                Save
              </button>
            </div>
          </Modal>
          ...
          >
            ...
            <div className="text-right md:mt-2">
              ...
              <Button
                ...
                icon="pi pi-check"
                className="p-button-text"
                onClick={() => deleteEmployeeSkills(deleteData)}
              />
            </div>
          </Modal>

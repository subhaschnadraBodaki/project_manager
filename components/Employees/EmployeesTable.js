...
export default function EmployeesTable ({actionBody}) {
    const columns = [
    ...
    return (
        <div >
            <DataTable value={data} resizableColumns columnResizeMode="expand"  paginator
                ...
                paginatorLeft={paginatorLeft} paginatorRight={paginatorRight} className="p-datatable-responsive-demo" header ="Responsive" >

...
// const Adata = useQuery('products', AccountsData)
// console.log(Adata)
...
//   const dropdownOptionsCurrency = Cdata.map((cdata)=>{key:'cdata.code'})
 ...
 return (
    ...
    <Form className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-x-12 lg:gap-x-28  md:gap-x-28 ml-8 md:gap-y-3 px-20 py-6 md:mx-28
    " autoComplete="off">

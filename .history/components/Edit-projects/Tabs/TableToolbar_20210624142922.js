...
export default function TableToolbar(props) {
    ...
    const leftToolbarTemplate = () => {
        return (
            <React.Fragment>
                <button className="bg-blue-900 px-5 py-3 text-sm shadow-sm font-medium tracking-wider text-white rounded-2xl hover:shadow-lg hover:bg-blue-600 flex" onClick={()=> console.log("working")}><PlusIcon className="h-5  w-5"/> Add Task</button>
            </React.Fragment>
        )
      }

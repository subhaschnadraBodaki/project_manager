...
const leftToolbarTemplate = () => {
    ...
    return (<>
        ...
        <React.Fragment>
            <button className="bg-blue-900 px-5 py-3 text-sm shadow-sm font-medium tracking-wider text-white rounded-2xl hover:shadow-lg  flex"  onClick={()=> setTaskIsOpen(true)}  ><PlusIcon className="h-5  w-5" /> Add Task</button>
        </React.Fragment>
    </>
    )
  }
    ...
    return ( 
        <div>
            <div>
              ...
              <DataTable value={UpdatedTaskData} resizableColumns columnResizeMode="expand">
                        {dynamicColumns}

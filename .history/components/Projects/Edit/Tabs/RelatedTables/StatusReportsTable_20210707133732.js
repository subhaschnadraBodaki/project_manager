...
import EditPrjStatusReport from '../../EditForms/EditPrjStatusReport'
...
const deleteProduct = (deleteData) => {
        let  _statusReport = statusReport.filter(val => val.project_id !== deleteData.project_id);
    ...
    const ActionButton = (rowData) => {
         ...
         return (
            ...
            <div className="grid grid-cols-3">
             ...
             <div>
              <EditPrjStatusReport projectId={projectId} editData={editData} />
